...
## fig 3A ##
######################################################
def get_lambda2_2layer_thm(G,deltas,chis):
    """
    Parameters
    ----------
    G: a list of a network's properties
...
## fig 3B ##
######################################################
def get_lambda2_2layer_exact(G,omegas,deltas,chis):
    """
    Parameters
    ----------
    G: a list of a network's properties
...
def get_dlambda2_ddelta_thm(G,chis):
    """
        Parameters
        ----------
        G: a list of a network's properties
...
## fig 3C ##
######################################################
def get_optima(G,omegas,deltas,chis):
...
## fig 3D ##
######################################################
def get_Leval2_2layer_eachlayer(G,chis):
    """
        Parameters
        ----------
        G: a list of a network's properties
